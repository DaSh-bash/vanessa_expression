...
p <- ggplot(data=resAdult_hedata, aes(x=log2FoldChange, y=-log10(pvalue), col=diffexpressed, label = delabel)) + geom_point() + theme_classic()  + ylim(0, 18)+ xlim(-20, 20) + theme(aspect.ratio = 6/6)+ geom_vline(xintercept=c(-2, 2), col="black", linetype = 2)  + scale_color_manual(values=c("#9b2c00", "grey", "#084748"))
...
p <- ggplot(data=resAdult_abdata, aes(x=log2FoldChange, y=-log10(pvalue), col=diffexpressed, label = delabel)) + geom_point() + theme_classic()  + ylim(0, 18) + xlim(-20, 20)+ theme(aspect.ratio = 6/6)+ geom_vline(xintercept=c(-2, 2), col="black", linetype = 2)  + scale_color_manual(values=c("#9b2c00", "grey", "#084748"))
...
p <- ggplot(data=resAdultLD_hedata, aes(x=log2FoldChange, y=-log10(pvalue), col=diffexpressed, label = delabel)) + geom_point(size = 1.2) + theme_classic() + theme(aspect.ratio = 6/6) + ylim(0, 20)+ xlim(-30, 30)  + geom_vline(xintercept=c(-2, 2), col="black", linetype = 2, linewidth=0.4)  + scale_color_manual(values=c("#9b2c00", "grey", "#084748"))
...
p <- ggplot(data=resAdultLD_abdata, aes(x=log2FoldChange, y=-log10(pvalue), col=diffexpressed, label = delabel)) + geom_point() + theme_classic() + ylim(0, 20)+ xlim(-30, 30) + theme(aspect.ratio = 6/6)+ geom_vline(xintercept=c(-2, 2), col="black", linetype = 2)  + scale_color_manual(values=c("#9b2c00", "grey", "#084748"))
...
c(row.names(resAdultLD_he05),row.names(resAdultLD_he05),row.names(resAdultLD_ab05),row.names(resAdult_ab05))
