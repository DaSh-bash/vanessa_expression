...
ma3 = assay(rlog(ddsLTR1))[row.names(resLTR105),]
```
...
#### Pattern analysis
```{r}
resDEG<-degPatterns(ma3, metadata = colDataLTR1,time = "devstage",col="condition")
resDEG
```
...
pattLIab <- degPatterns(maLIab, metadata = colDataLTRLIab,time = "devstage",col="condition")
pattLIab
```

```{r}
maLIhe = assay(rlog(ddsLTRLIhe))[row.names(resLTRLIhe),]
degPatterns(maLIhe, metadata = colDataLTRLIhe,time = "devstage",col="condition")
